"""
Django settings for my_project project on Heroku. For more info, see:
...
SECRET_KEY = "w&)2dsst+4-a&g5_fek30s1ovvm-$tx&y#apr3*j5*p^!x4sv8"
...
MIDDLEWARE = [
    ...
    'my_project.ExceptionMiddleware.ConsoleExceptionMiddleware'
]
